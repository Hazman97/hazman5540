...
<template>
  <div class="px-[15%]">
    <div class=" relative z-10 dark:bg-[#0a192f] py-10">
      <div
        class="absolute top-0 -left-4 w-72 h-72 rounded-full bg-purple-300 dark:bg-purple-300/20 blur-2xl animate-move-spin-scale"
      ></div>
      <div
        class="absolute top-5 -left-10 w-40 h-40 rounded-full bg-blue-300 dark:bg-blue-300/20 blur-2xl animate-move-spin-scale"
      ></div>
      <h2
        class="font-semibold text-center text-4xl capitalize text-black dark:text-[#ccd6f6]"
      >
        contact me
      </h2>
      <div
        class="flex flex-col sm:flex-col md:flex-row md:justify-between gap-2 relative z-2"
      >
        <div
          class="bg-white/30 dark:bg-black/10 backdrop:blur-xl dark:mt-10 container w-full h-50 py-10 px-10 rounded-xl"
        >
          <h1 class="text-center text-3xl font-semibold capitalize mb-5"></h1>
        ...
        >
          ...
          <div class="flex flex-col gap-3 mt-5">
            <a
              ...
              target="_blank"
              class="text-slate-700 dark:text-slate-400 font-semibold items-center flex gap-2"
            >
              <span>
                <svg
                  width="24"
            ...
            <a
              href="https://www.google.com/maps/place/Shah+Alam,+Selangor/@3.1017871,101.4110135,11.62z/data=!4m6!3m5!1s0x31cc4d8b932abdc7:0x6e65e085abb091c5!8m2!3d3.073281!4d101.518461!16zL20vMHN5cmY?entry=ttu"
              class="text-slate-700 dark:text-slate-400 font-semibold flex item-center gap-2"
            >
              <span>
                <svg
                  width="24"
