...
const articles: Article[] = [
  ...
  {
    title: 'Vue 3 Composition API & State Management Patterns',
    date: 'AUG 2025',
    readTime: '4 min read',
    excerptBefore: 'A practical look into organizing reusable composables and keeping single-source-of-truth states clean',
    highlightText: 'without unnecessary state bloat',
    excerptAfter: 'in complex dashboard applications.',
    tags: ['vue3', 'typescript', 'architecture'],
  },
  {
    title: 'Designing Cozy Nocturnal Interfaces with Dual Mode Support',
    date: 'JUL 2025',
    readTime: '3 min read',
    excerptBefore: 'Exploring dark mode aesthetics that feel personal and warm through hand-drawn organic line-art, warm gold accents, and',
    highlightText: 'adaptive light & dark styling',
    excerptAfter: 'rather than plain cold gray cards.',
