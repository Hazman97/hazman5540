      ...
      <div class="hidden md:flex items-center gap-8">
        ...
        <div class="relative">
          <button
            ...
            class="flex items-center gap-1.5 px-3 py-2 text-xs font-mono bg-slate-100 dark:bg-slate-800 text-teal-600 dark:text-accent border border-slate-200 dark:border-slate-700 rounded-xl transition-all hover:scale-105"
          >
            <span class="font-bold">v1</span>
          ...
          <div
            v-if="isDropdownOpen"
            class="absolute right-0 mt-2 w-44 bg-white dark:bg-[#112240] border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl py-1.5 z-50 text-xs font-mono"
          >
            <div class="px-3 py-1 text-[10px] text-slate-400 dark:text-slate-500 uppercase tracking-wider">
              Switch Version
            </div>
            <button
              @click="switchVersion('v2')"
              class="w-full flex items-center justify-between px-3 py-2 text-left hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 transition-colors"
            >
              <span>v2 (Nocturnal)</span>
            </button>
            <button
              @click="switchVersion('v1')"
              class="w-full flex items-center justify-between px-3 py-2 text-left bg-teal-500/10 text-teal-600 dark:text-accent font-semibold transition-colors"
            >
...
export default {
  ...
  data() {
    return {
      ...
      navItems: [
        { name: "Home", to: "/v1#home" },
        { name: "About", to: "/v1#about" },
        { name: "Experience", to: "/v1#experience" },
        { name: "Projects", to: "/v1#projects" },
        { name: "Contact", to: "/v1#contact" },
      ],
    };
  },
  mounted() {
